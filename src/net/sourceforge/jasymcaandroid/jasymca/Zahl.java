...
// String representation of pi: \u03c0
	...
	public static Algebraic SQRT2 = new Polynomial(new Root(
						new Vektor(new Algebraic[]{new Unexakt(-2.), ZERO, ONE}),0)); 
	public static Algebraic SQRT3 = new Polynomial(new Root(
						new Vektor(new Algebraic[]{new Unexakt(-3.), ZERO, ONE}),0)); 
