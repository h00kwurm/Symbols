% Demo Symbols Octave Mode - Mobile Edition specifically 
% reduced input text to make it more readable
p = 5000;
printf("Welcome to the Live-Demonstration of Symbols\n");
pause(200);
printf("Stop at any time using Menu: Interrupt.\n");
printf("\n\n");
pause(2000);
printf("\n\n\n");
